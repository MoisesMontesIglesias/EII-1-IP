...
public class WheelTest
{
    ...
    // /**
     // * Test del reviewPressure 
     // */
    // @Test
    // public void reviewPressureWithBasePressure(){
        // double pressure = 900;
        // double maxPressure = 1000;
        // double basePressure = pressure;
        // Wheel w = new Wheel(maxPressure, pressure);
        // Verificamos el valor de retorno del método
        // assertEquals(pressure, w.reviewPressure(basePressure), 0.1);
        // Verificamos que el método modifica el valor del atributo pressure
        // assertEquals(pressure, w.getPressure(), 0.1);
        // Verificar que el método NO MODIFICA el valor de otros atributos
        // assertEquals(maxPressure, w.getMaxPressure(), 0,1);
    // }
}
