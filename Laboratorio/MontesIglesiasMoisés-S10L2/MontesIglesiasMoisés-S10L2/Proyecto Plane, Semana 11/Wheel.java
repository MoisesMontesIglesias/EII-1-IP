...
public class Wheel
{
    ...
    public static final double INTERVAL_BP = 25;
    ...
    private void setAmountPressure(double amountPressure)
    {
        checkParam(amountPressure >= 0, "Presión de inflado negativa");
        this.amountPressure = amountPressure;
    }
     ...
     * @return presión máxima que puede soportar la rueda, de tipo double
     */
    public double getAmountPressure(double amountPressure)
    {
        return this.amountPressure;
    }
    
    private void setBasePressure(double basePressure)
    {
        checkParam(basePressure >= 0, "Presión base negativa");
     ...
     * @return presión máxima que puede soportar la rueda, de tipo double
     */
    public double getBasePressure(double basePressure)
    {
    ...
    /**
     * método getPercentage que devuelve en porcentaje el valor de la presion entre la máxima presión
     */
    ...
    /**
     * Cambia la presión de la rueda por el valor que tu le des
     */
    public void changePressure(double p){
        setPressure(p);
    }
