...
public class WheelStrutTest
{
    ...
    public void defConstUniq(){
        ...
        assertEquals(WheelStrut.IS_DEPLOYED, ws.isDiployed());
        assertNotNull(ws.getLeftWheel());
        assertEquals(Wheel.Strut.BOEING_737_PRESSURE, ws.getLeftWheel().getMaxPressure());
        assertEquals(Wheel.Strut.BOEING_737_PRESSURE, ws.getLeftWheel().getPressure());
