...
public class WheelTest
{
    ...
    public void toStringTrue(){
        ...
        Wheel w = new Wheel(pm, p);
        assertEquals("MaxP: 1000.0 Mb - Pressure: 100.0 Mb - Percentage: 10.0 - Test: true", w.toString());        
    }
    ...
    public void toStringFalse(){
        double pm = 1000, p = 100;
        Wheel w = new Wheel(pm, p);
        assertEquals("MaxP: 1000,0Mb - Pressure: 100,0 Mb - Percentage: 10,00 - Test: false", w.toString());        
    }
}
