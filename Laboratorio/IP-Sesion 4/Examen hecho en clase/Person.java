...
public class Person
{
    ...
    /**
     * Edad mínima para que un hombre trabaje como piloto de un avión
     */
    public final static int START_AGE_MEN = 30;
    
    /**
     * Edad máxima para que un hombre trabaje como piloto de un avión
     */
    public final static int FINAL_AGE_MEN = 50;
    
    /**
     * Descuento aplicado a personas entre 18 y 65 años
     */
    public final static int DISCOUNT_ADULTHOOD = 0;
    
    /**
     * Descuento aplicado a personas entre 12 y 18 años
     */
    public final static int DISCOUNT_TEEN = 5;
    
    /**
     * Descuento aplicado a personas mayores de 65 años
     */
    public final static int DISCOUNT_RETIREMENT = 10;
    
    /**
     * Descuento aplicado a niños menores de 12 años
     */
    public final static int DISCOUNT_KID = 15;
    
    /**
     * Edad de un niñ@
     */
    public final static int KID_AGE = 12;
    ...
    public Person(int age) {
        this();
        this.setSurname(DEFAULT_NAME);
        this.setName(DEFAULT_SURNAME);
        this.setAge(age);
        this.setGender(DEFAULT_GENDER);
    }
    ...
    /**
     * Aplicación del método getDicount en el que se va a aplicar un descuento según tu edad. Si el cliente es menor de 12 años
     * recibirá un 15% de descuento; si tiene entre 12 y 18, del 5%; si tiene entre 18 y 65 del 0%; y si tiene más de 65 años 
     * obtendrá un descuento del 10%.
     */
    public String getDiscount(){
        if (getAge() > RETIREMENT_AGE){
            return  getName() + " ya que tienes " + getAge() + " vas a recibir un descuento del " + DISCOUNT_RETIREMENT + "%";
        }
        if (getAge() < KID_AGE){
            return  getName() + " ya que tienes " + getAge() + " vas a recibir un descuento del " + DISCOUNT_KID + "%";
        }
        if ((getAge() < RETIREMENT_AGE) && (getAge() > ADULTHOOD_AGE)){
            return  getName() + " ya que tienes " + getAge() + " vas a recibir un descuento del " + DISCOUNT_ADULTHOOD + "%";
        }
        else {
            return getName() + " ya que tienes " + getAge() + " vas a recibir un descuento del " + DISCOUNT_TEEN + "%";
        }
    }
    
    /**
     * Aplicación del método canBePilot en el que si eres mujer y tienes entre 18 y 65 años
     * tendrás permitido ser piloto, en caso contrario, no; en el caso de los hombres deben
     * tener entre 30 y 50 años para poder serlo, en caso contrario, no podrán ser pilotos.
     */
    public boolean canBePilot(){
        if (gender == false){
            ...
            if ((getAge() >= START_AGE_MEN) && (getAge() <= FINAL_AGE_MEN)){
                return true;
            }
            else{
                return false;
