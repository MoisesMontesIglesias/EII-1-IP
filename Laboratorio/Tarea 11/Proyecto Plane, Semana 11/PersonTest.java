...
public class PersonTest
{
    ...
    public void constructorUniqCase(){
        ...
        assertEquals(Person.MAX_AGE, p.getAge());
        assertEquals(Person.DEFAULT_GENDER, p.getGender());
    }
    
    /**
     * Prueba del método setCriticalAge. 
     * 1.- Dentro de límites
     */
    @Test
     ...
     */
    @Test
    public void getHashCodeOutsideLimits() {
        try {
            Person p = new Person();
            p.setName(null);
    ...
    public void constDef(){
        ...
        assertEquals(Person.DEFAULT_NAME, person1.getName());
        assertEquals(Person.DEFAULT_SURNAME, person1.getSurname());
        assertEquals(Person.DEFAULT_GENDER, person1.getGender());
        
        assertFalse(person1.getAge()>=Person.MIN_AGE && person1.getAge()<Person.MAX_AGE);
    }
}
