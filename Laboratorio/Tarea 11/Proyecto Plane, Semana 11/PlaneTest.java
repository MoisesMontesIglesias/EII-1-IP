...
public class PlaneTest
{
    ...
    public void constructorDefaultUniqCase(){
        ...
        assertNotNull(pl.getLandingGear());
    }
    ...
    { //CASO 2 creo un avión sin piloto
       ...
       + "-NO PILOT" + "-(" + plane1.getPositionFromX() + "," + plane1.getPositionFromX() + ")"+ "-(" + plane1.getSpeedFromX()
       + "," + plane1.getSpeedFromY() + ")" ,plane1.toString());
    }
}
